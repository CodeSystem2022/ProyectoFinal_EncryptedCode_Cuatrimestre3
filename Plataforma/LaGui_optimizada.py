#Roberto Perez - Codigo optimizado y ejecutable con graficos
...
class VentanaPrincipal(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Plataforma de Usuarios")
        ...
        # Segunda pestaña: Actualización
        self.tab2 = tk.Frame(self.tabControl)
        self.tabControl.add(self.tab2, text="Actualización")
        ActualizarVentana(self.tab2, self)

        # Tercera pestaña: Eliminación
        self.tab3 = tk.Frame(self.tabControl)
        self.tabControl.add(self.tab3, text="Eliminación")
